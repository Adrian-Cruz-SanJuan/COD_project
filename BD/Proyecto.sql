...
CALL IO_K_C('DANIELA','RUBIALES','DANIELA@GMAIL.COM',AES_ENCRYPT('CONTRAPASSWORD','gato'),'2019-07-06');

SELECT * FROM USUARIO;

SELECT CAST(AES_DECRYPT(PASSWORD_U,'gato') AS CHAR) FROM USUARIO/* WHERE USUARIO_ID = 'USER2'*/;
