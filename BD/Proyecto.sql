...
CREATE PROCEDURE IO_K_C(
    ...
    BEGIN
		...
		INSERT INTO USUARIO(USUARIO_ID,NOMBRE_U,APELLIDO_U,CORREO_U) 
        VALUES (@YUKO,PRO_NOMBRE_U,PRO_APELLIDO_U,PRO_CORREO_U);    
...
CALL IO_K_C('DANIELA','RUBIALES','DANIELA@GMAIL.COM');
