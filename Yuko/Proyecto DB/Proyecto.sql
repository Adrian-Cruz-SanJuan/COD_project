...
CALL Creacion_id_usuario('ADRIAN','CRUZ','CORREO@GMAIL.COM',AES_ENCRYPT('tacosde.canasta','GATO'),'2019-08-05');
SELECT * FROM USUARIO;

SELECT PASSWORD_U FROM USUARIO;

SET @YUKO = (SELECT USUARIO_ID FROM USUARIO ORDER BY USUARIO_ID DESC LIMIT 1);
SELECT CAST(AES_DECRYPT(PASSWORD_U,'GATO') AS CHAR) FROM USUARIO WHERE USUARIO_ID = @YUKO;